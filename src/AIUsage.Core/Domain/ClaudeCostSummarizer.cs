...
public static class ClaudeCostSummarizer
{
    public static ProviderUsageSummary Summarize(RawUsageSnapshot snapshot)
    {
        ...
        var cost = ReadCostSummary(snapshot);
    ...
    private static ProviderCostSummary ReadCostSummary(RawUsageSnapshot snapshot)
    {
        ...
        return ProviderCostSummary.Create(
            ...
            ReadPeriod(facts, "overall", "Overall", forceDefaultLabel: true),
