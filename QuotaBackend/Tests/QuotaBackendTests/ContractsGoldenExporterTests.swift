...
enum CanonicalRequestGoldenScenarios {
    ...
    static func project(_ response: CanonicalResponse) -> AnyCodable {
        var value: [String: AnyCodable] = [
...
enum CanonicalBridgeGoldenScenarios {
    ...
    static func project(_ note: CanonicalLossyNote) -> AnyCodable {
        var value: [String: AnyCodable] = [
